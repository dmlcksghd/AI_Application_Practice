...
def get_args(rest_args):
    ...
    parser.add_argument('--load_model_actor_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_9_11_19/actor_400000.pth",
                        help='month_day_hour_minute')
    parser.add_argument('--load_model_critic_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_9_11_19/critic_400000.pth",
                        help='month_day_hour_minute')
    parser.add_argument('--load_model_encoder_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_9_11_19/encoder_400000.pth",
                        help='month_day_hour_minute')
