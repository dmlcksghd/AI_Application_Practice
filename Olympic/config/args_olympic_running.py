...
def get_args(rest_args):
    ...
    parser.add_argument('--solved_reward', type=int, default=75, help='desired reward')
    ...
    parser.add_argument('--period_save_model', type=int, default=300000, help='period_save_model')
    parser.add_argument('--load_model', type=boolean_argument, default=True, help='load previous model')
    # parser.add_argument('--load_model_time', type=str, default="12_8_12_21", help='month_day_hour_minute')
    parser.add_argument('--load_model_actor_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_10_2_37/actor_solved.pth",
                        help='month_day_hour_minute')
    parser.add_argument('--load_model_critic_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_10_2_37/critic_solved.pth",
                        help='month_day_hour_minute')
    parser.add_argument('--load_model_encoder_path', type=str,
                        default="C:/Users/theho/git_AI_Application_Practice/Olympic/train_history/olympics-running/12_10_2_37/encoder_solved.pth",
                        help='month_day_hour_minute')
